...
//---------------------------------------------------------------------------
//////////////////////////////////////////////////////////////////////////////
//...identification of cohesion parameters (for gradient and classical model);
...
//...reading parameters of inclusion;
	...
	if (id_layer == SPECIAL_STATE && ! id_reading) {//...окружность (для сведения);
		fff = 4./3.*M_PI*R*R*R/(A*A*A);
		double aaa = (A-R)/(1.-sqrt(fff/M_PI));
		double rad = sqrt(fff/M_PI)*aaa;
		A = aaa;
		R = rad;
//   number os experimental points:
//   rad		aaa	 aaa/2
...
/////////////////////////////////////////////////////////
//...defining sizes of cell and install boundary surface;
...
//...install problem parameters;
	if (id_layer != NULL_STATE && id_layer != SPECIAL_STATE) {
		...
		sm->set_quad(PackInts(8, 4)); //...quadratures degree;
	...
	sm->set_param(3, Ad); //...adhesion moduli Ad and Bd;
	sm->set_param(4, Bd);

////////////////////////////
//...solving of the problem;
//	sm->solver.change(EXTERN_STATE);//...switch on external solver;
...
//////////////////////////////////////////
//..energy calculation (or mean stresses);
	double EYoung = 0.;
#ifdef ___MPI_INIT___
...
///////////////////////////////////////////////////////////////////
//...identification of cohesion parameters for spherical inclusion;
...
//////////////////////////////////////////
//...making model for spherical inclusion;
...
///////////////////////////////////////////////////////////////////
//..calculating Young modulus and reproducing sterss distributions;
	double EYoung = 0.;
#ifdef ___MPI_INIT___
	if (comm_mpi.GetMyid() == 0) 
#endif
...
////////////////////////////////////////////////////////////////////////
//...one-dimentional modle of interphase layer (symmetry layered media);
