...
//...operation with all input points;
	if (0 <= i && i < this->N && this->B[i].shape && this->B[i].mp) {
		int m = this->solver.id_norm;
//===============================================================//
//...задание тестовых коэффициентов в задаче Эшелби (28.09.2016);
...
//...calculation filtration pressure;
				...
				F[0] += Z;
//=============================================//
//...тестовый расчет задачи Эшелби (14.10.2016);
...
/////////////////////////////////////////////////////////////////////////////////////////
//... тестовый расчет обтекания сферической пористой частицы с условиями Биверса-Джозефа;
template <typename T>
...
//...градиентная часть основного потенциала;
...
//...градиентная часть гармонического потенциала;
